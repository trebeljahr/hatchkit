...
- paired/project-scoped clients and sites for GlitchTip (errors), OpenPanel/Plausible (analytics), and Resend (email),
...
- [Secrets rotation](./secrets-rotation) — keypair vs. provider credentials, when to use which
