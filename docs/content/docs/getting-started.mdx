...
- **Metadata** (URLs, user IDs, non-secret IDs) → Hatchkit's config file; see [Config directory override](./providers#config-directory-override) for isolated state with `HATCHKIT_CONF_DIR`.
