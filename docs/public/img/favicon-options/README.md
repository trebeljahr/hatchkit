...
- `hatch-egg-05-terminal.svg`: egg plus tiny prompt/cursor cue.
- `hatch-egg-06-tiles.svg`: keeps more of the current diagonal logo language.

Open `preview.html` to compare each option at 16px, 32px, and 64px. Use
`contact-sheet.png` for a quick static overview.
